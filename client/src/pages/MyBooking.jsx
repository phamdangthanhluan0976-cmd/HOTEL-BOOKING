            ...
            <div className='max-w-6xl mt-8 w-full text-gray-800'>
                ...
                {MyBookings.map((booking) => (
                    <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                        ...
                        {/* date timeings */}
                        <div className='flex flex-row md:items0-center md:gap-12 mt-3 gap-8'>
                            <div className="">
                                <p>Check-In:</p>
                        ...
                        <div className='flex flex-col items-start justify-center pt-3'>
                            ...
                            {!booking.isPaid && (
                                <button className='px-4 py-1.5 mt-4 text-xs border border-gray_400 rounded-full hover:bg-gray-50 transition-all cursor-pointer'>
                                    Pay Now
                                </button>
                            )}
                        </div>
