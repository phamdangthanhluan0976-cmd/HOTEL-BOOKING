                    ...
                    <tbody className='text-sm'>
                        {
                            rooms.map((item, index) => (
                                <tr key={index}>
                                    ...
                                    <td className='py-3 px-4 text-gray-700 text-center border-t border-gray-300 max-sm:hidden'>
                                        {item.pricePerNight}
                                    </td>
                                    <td className='py-3 px-4 text-gray-700 border-t border-gray-300 max-sm text-red-500 text-center'>
                                        <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                                            ...
                                            <span className='dot absolute left-1 w-5 h-5 bg-white rounded-full transition-transform duration-200 aese-in-out peer-checked:translate-x-5'>
