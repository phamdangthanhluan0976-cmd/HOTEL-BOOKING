...
const Dashboard = () => {
    ...
    return (
        <div>
            <Title align='left' font='outfit' title='Dashboard' subTitle='Monitor your room listings, track bookings and analyze revenye0all in one place. Stay updated with real-time insights to ensure smooth operations.' />
