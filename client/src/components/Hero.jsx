...
const Hero = () => {
  return (
    <div
      className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-32 text-white bg-no-repeat bg-cover bg-center h-screen'
      ...
      <form className='bg-white text-gray-500 rounded-lg px-6 py-4 mt-10 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
        ...
        <div>
          <div className='flex items-center gap-2'>
            <img src={assets.calenderIcon} alt="" className='w-4' />
